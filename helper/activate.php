...
create_tables();
echo "\n";
echo '15 2 * * 1 indexer --config  ' . elgg_get_data_path() . '/sphinx/sphinx.conf --rotate ' . $CONFIG->sitename . '_metastrings_main';
echo "\n";
echo '*/15 * * * * indexer --config  ' . elgg_get_data_path() . '/sphinx/sphinx.conf --rotate ' . $CONFIG->sitename . '_metastrings_delta';
echo "\n";