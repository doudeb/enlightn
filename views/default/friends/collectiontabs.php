...
$(document).ready(function () {
	...
	$('a.collectionmembers<?php echo $friendspicker; ?>').click(function () {
		...
		$('#friends_picker_placeholder<?php echo $friendspicker; ?>').load('<?php echo $vars['url']; ?>mod/enlightn/ajax/pickercallback.php?username=<?php echo get_loggedin_user()->username; ?>&type=list&collection=<?php echo $collectionid; ?>&friendspicker=<?php echo $friendspicker; ?>');
	...
	$('a.editmembers<?php echo $friendspicker; ?>').click(function () {
		...
		$('#friends_picker_placeholder<?php echo $friendspicker; ?>').load('<?php echo $vars['url']; ?>mod/enlightn/ajax/pickercallback.php?username=<?php echo get_loggedin_user()->username; ?>&type=picker&collection=<?php echo $collectionid; ?>&friendspicker=<?php echo $friendspicker; ?>');
