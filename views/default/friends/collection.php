...
if ($friends = $vars['collection']->entities) {
	...
	$(document).ready(function () {
			...
			$('#friends_picker_placeholder<?php echo $vars['friendspicker']; ?>').load('<?php echo $vars['url']; ?>mod/enlightn/ajax/picker.php?username=<?php echo get_loggedin_user()->username; ?>&type=list&collection=<?php echo $vars['collection']->id; ?>');
