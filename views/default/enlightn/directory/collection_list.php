...
?>
        ...
        <div id="sidebar" class="directory">
            <ol class="folders">
                <li class="<?php echo !$collection_id?' current':''?>"><a class="cat" href="<?php echo $vars['url']?>pg/enlightn/directory"><?php echo elgg_echo("enlightn:taball"); ?></a></li>
