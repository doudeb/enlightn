...
?>
  			<ol class="folders">
				...
				<li id="discussion_selector_invited"><span class="arrow"></span><a class="cat"  onclick="$('#unreaded_only').val(0);changeMessageList('#discussion_selector_invited',5)" href="#"><?php echo elgg_echo('enlightn:membershiprequest'); ?><?php echo echo_unreaded($unreaded, ENLIGHTN_INVITED)?></a></li>
