...
?>
					...
					<li id="embedFile<?php echo $file->guid; ?>" class="msg msg_home read">
                            ...
                            <div class="excerpt" id="excerpt<?php echo $file->guid; ?>">
                                <h3><a href="<?php echo $vars['url'] . 'mod/file/download.php?file_guid=' .$file->guid;?>" target="_blank"><?php echo $file->title?></a></h3>
 ...
 <script>
		$("#excerpt<?php echo $file->guid; ?>").click( function(){
            window.open('<?php echo $vars['url'] . 'mod/file/download.php?file_guid=' .$file->guid;?>', '_blank');
		});
</script>