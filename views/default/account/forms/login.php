...
<div id="login">
    <div class="box">
        ...
        <p><a href="<?php echo $vars['url']?>account/forgotten_password.php"><?php echo elgg_echo('user:password:lost')?></a></p>
    </div>
    <div class="headline">
       <p><?php echo ($register_enabled == 1) ? "<a href=\"{$vars['url']}pg/register/\"><span class='button'>" . elgg_echo('register') . "</span></a> " : ""?></p>
    </div>
</div>
<script>
